		...
		<div class="ts-vcsc-section-main">
			...
			<div class="ts-vcsc-section-content">
				...
				<div class="ts-vcsc-notice-field ts-vcsc-success" style="margin-top: 10px; font-size: 13px; text-align: justify;">
					Here you can generate the HTML code and Shortcode for any of the Icon Fonts that are part of "Composium - WP Bakery Page Builder Extensions". Embed the shortcode / HTML code into the tinyMCE editor in order to utilize the font icons outside the WP Bakery Page Builder elements.
				</div>
