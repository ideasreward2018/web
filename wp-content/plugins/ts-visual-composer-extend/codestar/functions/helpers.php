...
if ( ! function_exists( 'cs_encode_string' ) ) {
  function cs_encode_string( $string ) {
    ...
    return rtrim( strtr( call_user_func( 'base64_encode', addslashes( gzcompress( serialize( $string ), 9 ) ) ), '+/', '-_' ), '=' );
  }
}
...
if ( ! function_exists( 'cs_decode_string' ) ) {
  function cs_decode_string( $string ) {
    ...
    return unserialize( gzuncompress( stripslashes( call_user_func( 'base64_decode', rtrim( strtr( $string, '-_', '+/' ), '=' ) ) ) ) );
  }
}
